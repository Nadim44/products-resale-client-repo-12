...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://assignment-12-server-nu.vercel.app/category/${params.id}`)
            },
            {
                path: '/signup',
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://assignment-12-server-nu.vercel.app/bookings/${params.id}`)
            }
        ]
    }
